...
I was graduated from Mathematics department of  Middle East Technical University in 2012. After graduation, i was sure that my profession will be in the IT sector.For this reason, to improve my knowledge about software development, i started my Master degree in Informatics Institute, METU. In those years, i've also worked as a Research Assistant. Through my research area years, i was doing  statistical tests, but this  process was only a tool for me. i was focused on results not the process. Simply, IBM SPSS was doing it for me. When i first understood the idea behind lineer regression with the Machine Learning Course from Coursera i was fascinated with the idea and decided to learn more about it.
